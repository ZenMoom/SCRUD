...
class DiagramFacade:
    ...
    async def get_diagram(
        ...
        return await self._diagram_service.get_diagram(project_id, api_id, version)
    ...
    async def update_component_position(
        ...
        return await self._diagram_service.update_component_position(
    ...
    async def _call_llm(
        ...
        return await self._diagram_service.create_diagram_from_prompt_result(
