...
from app.core.generator.diagram_create_generator import DiagramCreateGenerator
...
class DiagramService:
    ...
    async def create_llm_diagram(
        ...
        try:
            diagram_create_generator = DiagramCreateGenerator(llm)

            from app.infrastructure.mongodb.repository.model.diagram_model import Diagram
            diagram: Diagram = await diagram_create_generator.generate_diagram_with_llm(
                project_id=project_id,
                api_id=api_id,
                global_files=global_files,
                api_spec=api_spec,
