  ...
  return (
    <div className="bg-gradient-to-b from-white to-gray-50 h-[calc(100vh-60px)]">
      {isAuthenticated ? (
        ...
        <div className="flex flex-col items-center justify-center h-[calc(100vh-60px)] bg-white p-4">
          ...
          <button onClick={handleLogin} className="bg-gray-800 hover:bg-gray-700 text-white px-4 py-3 rounded-md text-2xl font-medium transition-all">
            SCRUD 사용해 보기
          </button>
        </div>
      )}
