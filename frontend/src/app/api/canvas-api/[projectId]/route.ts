  ...
  try {
    ...
    try {
      ...
      try {
        ...
        const alternativeResponse = await fetch(`${apiUrl}/api/v1/projects/${projectId}/apis?include=AI_GENERATED&include=USER_COMPLETED`, {
          method: "GET",
          headers: {
            "Content-Type": "application/json",
          },
    ...
    return NextResponse.json({ error: "API 목록을 불러오는 중 오류가 발생했습니다: " + apiError.message }, { status: 500 })
  }
}
