...
const PathParamsTab: React.FC<PathParamsTabProps> = ({ pathParamsJson, setPathParamsJson, formatJson, endpoint }) => {
  return (
    <div>
      ...
      <textarea className="w-full border rounded px-2 py-1 font-mono text-sm" value={pathParamsJson} onChange={(e) => setPathParamsJson(e.target.value)} style={{ height: "180px" }} />
