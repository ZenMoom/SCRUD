...
import { Clock, Info, RefreshCw, Send, X } from 'lucide-react';
      ...
      while ((match = codeBlockRegex.exec(cleanMessage)) !== null) {
        ...
        parts.push(
          <div
            ...
            className='my-4 overflow-hidden border border-gray-300 rounded-md'
          >
            ...
            if (msg.type === 'user') {
              ...
              return (
                ...
                >
                  ...
                  <span className='self-start mt-1 text-xs text-gray-500'>
      ...
      <div className='p-3 border-t'>
        <div className='flex flex-col gap-2'>
          ...
          <div className='flex items-center gap-1'>
            ...
            <div className='py-0.5 flex items-center gap-1 px-2 text-xs text-gray-800 bg-gray-100 rounded-md'>
              <span>{selectedTag}</span>
              <button
                onClick={handleTagClear}
                className='p-0.5 hover:bg-gray-200 ml-1 text-gray-500 transition-colors rounded-full'
                aria-label='요청 태그 해제'
              >
                <X size={10} />
              </button>
