...
const ERDForm = forwardRef<HTMLDivElement, ERDFormProps>(({ title, value, onChange, onFocus, isRequired }, ref) => {
    ...
    >
      <div className='flex flex-col mb-4'>
        ...
        <p className='mt-2 text-sm text-gray-600'>
          ERD(Entity-Relationship Diagram)는 데이터베이스의 구조와 관계를 시각적으로 표현한 다이어그램으로, SCRUD가 맞춤
          정보를 제공하는 데 필수적입니다.
        </p>
      </div>
